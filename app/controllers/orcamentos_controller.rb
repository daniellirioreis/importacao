class OrcamentosController < ApplicationController
  ...
  private
    ...
    def orcamento_params
      params.require(:orcamento).permit(:numero_orcamento, :data_emissao, :data_validade, :cpf_emitente, :inscest_emitente, :nome_emitente, :endereco_emitente, :bairro_emitente, :cidade_emitente, :uf_emitente, :cep_emitente, :telefone_emitente)
    end
end
